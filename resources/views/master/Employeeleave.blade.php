                                    ...
                                    <form action="{{url('/saves')}}" method="POST" onsubmit="return Validation()">
                                     @csrf
                                        <div class="form-group">
                                            ...
                                            <option vlaue="" disabled selected > Select Leave Type </option>
                                            <option vlaue="cl">Casual Leave</option>
                                            <option vlaue="el">Emergency Leave</option>
                                            <option vlaue="sl"> Sick Leave</option>
                                            <option vlaue="lwp"> Leave Without Pay</option>
                                            </select>
...
<script>
    function Validation() {
        ...
        if (select.value) {
            ...
            return false;
            document.getElementById('leavetyp').innerHTML = "Please select leave type";
        }
