...
<div class="content-page">
        ...
        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <a href="{{Route('Show.chat')}}">Recent Chats</a>
                                        </div>
                                        <div class="form-group mb-0">
                                            <div class="input-group input-group-sm">
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm search-chat" id="search-users" placeholder="Enter name" aria-label="Username" aria-describedby="basic-addon1">
            ...
            <!--------------------------------------------------------- Recent chat ----------------------------------------------------------------->     
                                    <div class="card-body item-list">     
                                        <ul id="all-users-list" role="custom-tab" class="recent-chats">
                                            @if(!is_null($AllUsers))
                                                @foreach($AllUsers as $list)
                                                    <a  href="javascript:void(0);" onclick="FetchUserMessages('fetch-user-messages','{{csrf_token()}}','{{$list->id}}','user-content-1','au')">
                                                    <li class="simple-item hover" data-toggle-extra="tab" data-target-extra="#user-content-1">
                                                        ...
                                                        <div class="simple-item-body">
                                                            <div class="simple-item-title">
                                                                @if(session('ACTIVE__USER_ID')==$list->id)
                                            ...
                                            @else
                                                <li class="simple-item hover" data-toggle-extra="tab" data-target-extra="#user-content-1">
                                                            &nbsp;&nbsp; &nbsp;&nbsp;You do not have any conversation</li>         
                                            @endif
                                        </ul>
                                    </div>
                                </div>
    ...
    <div class="col-lg-8 chat-right-wrapper" >
        ...
        @if(session('ACTIVE__USER_ID') && $SelectedUserId!=null)
            <div class="card">
        <!-------------------------------------------------- sidebar------------------------------------------------------------------- -->
                                    ...
                                    @if($list->SenderId== session('USER_ID'))
                                        ...
                                        @else
                                            <div class="single-msg user">
                                                <div class="triangle-topright single-msg-shap"></div>
                                                <div class="single-msg-content user">
                                                    <div class="msg-detail"><span> <em>This message was deleted </em> </span> <span style="padding-left:20px;font-size: 11px">{{$list->created_at->diffForhumans()}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                                            ...
                                            <div id="c-media" style="margin-right: 80%;padding-bottom: 10px;">
                                                @if($list->files==1)
                                                    ...
                                                    @foreach($list->MediaFiles as $media)
                                                        @if(!is_null($media->chat_file_name))
                                                            {{getMedia($media->id)}}
                                                                <br/><span>{{substr($media->chat_file_name,5)}} &nbsp;&nbsp; <a href="{{URL::asset('file-manager/media-files/Chat_media/'.$media->chat_file_name)}}" download="{{substr($media->chat_file_name,5)}}"  class="download-chat-file"><i class="fa fa-download" aria-hidden="true"></i></a></span>
                                                        @else
                                                                <span> <em>This message was deleted </em> </span>
                                                        @endif
                                                    @endforeach
    ...
    <div class="modal fade" id="edit-mssg-hstry" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body edit-mssg-hstry">
    ...
    <!-- END Modal -->
                ...
                <!---------------------------------------------------Message send----------------------------------------------------------------- -->
                    <div class="card-footer px-3 py-3" >
                        ...
                        <form id="msg-send">
                             <p id="files-area"><span id="files-names"></span></p>
                            <div class="input-group input-group-sm">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <input type="file" name="chat-media[]" style="display: none;" id="chat-media" class="chat-media-files" onchange="javascript:showChatFile();" multiple>
...
<script>
 const chatUserText = document.getElementById('chat-input');
chatUserText.addEventListener('keydown', function (e) {
