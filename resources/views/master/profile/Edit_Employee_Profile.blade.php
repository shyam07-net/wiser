                                 ...
                                 <div class=" row align-items-center">
                                    ...
                                    <div class="form-group col-sm-6 ">
                                       ...
                                       <div class="custom-control custom-radio custom-control-inline"  >
                                          ...
                                          <label class="custom-control-label" for="customRadio6" style="line-height:none"> Male </label>
                                       </div>
                                       <div class="custom-control custom-radio custom-control-inline" >
                                          <input type="radio" id="customRadio7" name="gender" value="Female" class="custom-control-input" {{ ($Gender == 'FeMale') ? 'checked' : ''}}>
                                          <label class="custom-control-label" for="customRadio7"  style="line-height:none"> Female </label>
                                       </div>
                                    </div>
                                    <div class="form-group col-sm-6">
