...
<div class="content-page">
            ...
            <div class="profile-box">
               <div class="profile-card rounded">
                 ...
                 @endif
                    ...
                    <input type="file"  id="file" name="profile_pic" required><input type="submit" id="update-btn"value="Save"></form> 
                    </div>
                    </div>
                    @if ($errors->has('profile_pic')) <span class="pi-error">{{ $errors->first('profile_pic') }}</span>@endif
                  <h3 class="font-600 text-white text-center mb-0">{{GetUserProfileName($Employee_Data->Employee_ID) ?? '' }} &nbsp;<a href="{{route('edit.employee.profile')}}"><i class="fa fa-edit" style="color:white"></i></a></h3>
  ...
  <tbody>
      <tr>
         <th>Name</th>
         <td>{{GetUserProfileName($Employee_Data->Employee_ID)  ?? ''}}</td>
      </tr>
