    ...
    <div class="draggable-item todo-board-card border-color-left-blue">
        <div class="item-body">
            ...
            <div class="info">
                ...
                <small>Project >{{$initiateTask->taskStatus->TaskStatus}}</small>
                <br/>
                <br/>
                  Created At <span class="badge rounded-pill bg-primary text-dark ">{{$initiateTask->created_at->diffForHumans()}} </span>
                
                  Last Updated <span class="badge rounded-pill bg-warning text-dark ">{{$initiateTask->updated_at->diffForHumans()}}</span>
                  <br/>
                  <br/>
             
            <h5>{{$initiateTask->Title}} &nbsp;<i class="fa fa-clock-o" aria-hidden="true" ></i></h5>
...
@if($initiateTask->file==1)
    @if($initiateTask->taskImages->mediaType=='IMG')
        ...
        &nbsp;&nbsp;&nbsp;<a href="{{URL::asset('file-manager/media-files/Task_Media/'.$initiateTask->taskImages->FileName)}}" download="{{substr($initiateTask->taskImages->FileName,strlen($initiateTask->id))}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
    ...
    @endif
@endif
<h1><br/><b></b> {{$initiateTask->userInfo->name}}</h1>
            </div>
            <div>
                <div class="rounded">
    ...
    <div class="draggable-item todo-board-card ">
        <div class="item-body">
            <div class="prog">
                ...
                <br/>
                <br/>
                created at <span class="badge rounded-pill bg-primary text-dark ">{{$ptasks->created_at->diffForHumans()}}</span>
...
@if($ptasks->file==1)
    @if($ptasks->taskImages->mediaType=='IMG')
        ...
        &nbsp;<a href="{{URL::asset('file-manager/media-files/Task_Media/'.$ptasks->taskImages->FileName)}}" download="{{substr($ptasks->taskImages->FileName,strlen($ptasks->id))}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
       <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/> 
    ...
    @endif
@endif
<h1><br/><b></b> {{$ptasks->userInfo->name}}</h1>
            </div>
            <div>
                <div class="rounded">
    ...
    <div class="draggable-item todo-board-card border-color-left-red">
        <div class="item-body">
            <div class="completed">
                ...
                created at <span class="badge rounded-pill bg-primary text-dark ">{{$ctask->created_at->diffForHumans()}}</span>
                last updated <span class="badge rounded-pill bg-warning text-dark ">{{$ctask->updated_at->diffForHumans()}}</span>
                <br/>
                </br>
                <h5>{{$ctask->Title}}&nbsp;@if($ctask->Status==3)<i class="fa fa-check-circle" style="color: green;"></i>@else <i class="fa fa-balance-scale" 
                ></i>@endif</h5>
                <br/>
...
@if($ctask->file==1)
    @if($ctask->taskImages->mediaType=='IMG')
        ...
        &nbsp;<a href="{{URL::asset('file-manager/media-files/Task_Media/'.$ctask->taskImages->FileName)}}" download="{{substr($ctask->taskImages->FileName,strlen($ctask->id))}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
       <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/> 
    ...
    @endif
@endif
<h1><br/><b></b> {{$ctask->userInfo->name}}</h1>
            </div>
            <div>
                <div class="rounded">
