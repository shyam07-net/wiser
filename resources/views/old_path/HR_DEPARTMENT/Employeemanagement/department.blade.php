...
<script>
    function Validation() {
        ...
        var depcode = document.getElementById('code').value;
        var depname = document.getElementById('name').value;
       

        if (depcode == "") {
            document.getElementById('dcode').innerHTML = "Please enter department code";
            return false;
        } else {
        ...
        if (depname == "") {
            document.getElementById('dname').innerHTML = "Please enter department name";
            return false;
        } else {
