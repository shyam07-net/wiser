                                        ...
                                        <td>{{$list->Status}}</td> 
                                         <td>
                                            <div class="d-flex justify-content-end align-items-center">
                                                <a class="badge bg-danger" data-toggle="modal" data-target="#delete" data-placement="top" title="" data-original-title="Delete" href="#">
                                    ...
                                    <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                    <a href="{{url('/delete/')}}/{{$list->id}}"><button type="submit" name="submit" class="btn btn-primary">Delete</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    function Validation() {
        ...
        if (reason == "") {
         ...
         if (department == "") {
            document.getElementById('depart').innerHTML = "Please enter reason";
            return false;
        } else {
